...
public class SceneHot
{
	 ...
	 */
	public SceneHot(int x,int y,int width,int height,String acceptableQuests,String acceptedQuests,String submitableQuests,String submitedQuests,SceneHotLink[] links)
	{
		this.x=x;
		this.y=y;
		this.width=width;
